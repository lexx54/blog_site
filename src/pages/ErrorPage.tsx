...
const ErrorPage = () => {
  ...
  return (
    <main className="h-screen w-full flex flex-col justify-center items-center bg-cs-purple">
	<h1 className="text-9xl font-extrabold text-white tracking-widest">404</h1>
	<div className="bg-cs-purple-light px-2 text-sm rounded rotate-12 absolute">
		Page Not Found
	</div>
	<button className="mt-5">
      ...
      >
        ...
        <span className="relative block px-8 py-3 bg-cs-purple border border-current">
